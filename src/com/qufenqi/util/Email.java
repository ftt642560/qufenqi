...
public class Email
{
	...
	public static void main(String[] args)
	{
		...
		String mailbody = "<a href='http://www.wphtu.ah.cn/' target='_blank'>广东海洋大学</a>发送成功了哦";//邮件正文
		themail.setNeedAuth(true);
		themail.setSubject("JAVA发邮件的测试");//邮件主题
		themail.setBody(mailbody);//邮件正文
		themail.setTo("1254171906@qq.com");//收件人地址  452088406@qq.com
		themail.setFrom("1254171906@qq.com");//发件人地址  
	//	themail.addFileAffix("");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法； 如果没有可以不写
		themail.setNamePass("1254171906@qq.com", "bdilubkpwnyibagj");//发件人地址和密码 **改为相应邮箱密码
		themail.sendout();
//		qtsfuumsivqshejg
	}
}

...
<nav class="nav">
 ...
 <div class="user-container">  
   <div class="main-container">
	...
	<tr>
	    <td class="goods-photo2"><img src="<%=basePath%>/image/p2.jpg" class="img-responsive" width="100px" alt=""/>
				 </td>
		<td style="width:250px;">简介</td>		
	    <td style="width:100px;">单价(元)</td>
		<td style="width:80px;">数量</td>
	    <td style="width:100px;">付款方式</td>
		<td style="width:100px;">交易状态</td></tr>
		</table>
	</div>
	</div>
	</div>

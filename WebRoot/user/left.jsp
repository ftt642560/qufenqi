            ...
            <td > <table width="100%" cellspacing="0" cellpadding="0" border="0"> 
                <tr> 
                  <td  class="left1"> 
                  	...
                  	&nbsp;&nbsp;&nbsp;&nbsp;
                  	<a id="exp51" title="折叠" href="javascript:widgets.ToggleWidget(hideTop1);">用户管理</a>
            ...
            <td class="left2" > <div id="hideTop1"  img="exp5" openAlt="折叠" closedAlt="展开"> 
                <table width="100%"  border="0" cellspacing="1" cellpadding="0"> 
                  ...
                  <tr> 
                    ...
                    <td><a href="<%=basePath%>/user/left.jsp" onClick="jsgoto('<%=basePath%>/user/USER1001.jsp');">用户管理</a></td> 
                  </tr> 
				  <tr> 
                    <td><div align="right"><img src="<%=basePath%>/image/dot1.gif" width="13" height="16"></div></td> 
                    <td><a href="<%=basePath%>/user/left.jsp" onClick="gotoclothing();">货号</a></td> 
                  </tr>                 
				   <tr> 
                    <td><div align="right"><img src="<%=basePath%>/image/dot1.gif" width="13" height="16"></div></td> 
                    <td><a href="<%=basePath%>/user/left.jsp" onClick="gotostore();">仓库</a></td> 
                  </tr>  
                  <tr> 
